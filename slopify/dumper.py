...
def dump_files_to_markdown(files: list[Path], output_file: Path, base_path: Path = None):
    """
    ...
    :param base_path: A Path object representing the base directory from which to calculate relative paths.
    """
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Dump directory contents to a Markdown file.')
    parser.add_argument('directory', type=str, help='Directory to dump contents from.')
    parser.add_argument('--extension', type=str, help='File extension to filter by.', default='')
    parser.add_argument('--output', type=str, help='Output Markdown file name.', default='dumped_contents.md')
    args = parser.parse_args()
    dump_directory_contents_to_markdown(args.directory, args.extension, args.output)
